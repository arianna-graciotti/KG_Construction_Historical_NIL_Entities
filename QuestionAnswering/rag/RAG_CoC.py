...
CONFIG = {
    "INPUT_CSVS": [
        "https://github.com/arianna-graciotti/KG_Construction_Historical_NIL_Entities/blob/291a694d0b0a58119113abf2af9430ac1c5f310b/QuestionAnswering/questions/QA_CoC_QID.csv",
        "https://github.com/arianna-graciotti/KG_Construction_Historical_NIL_Entities/blob/291a694d0b0a58119113abf2af9430ac1c5f310b/QuestionAnswering/questions/QA_CoC_NIL.csv"
    ],
    "PICKLE_FILE": #corpus broken down into paragraphs,
    "TOP_K": 3,
...
def process_retriever(retriever_type: str, df_in: pd.DataFrame, corpus: List[Tuple[str, str]], csv_basename: str):
    ...
    try:
        ...
        for idx, row in tqdm(df_in.iterrows(), total=len(df_in), desc=f"{retriever_type}"):
            ...
            complete_prompt = (
                "Your task is to determine the country of citizenship of a given person occurring in a given sentence based on some provided relevant context. "
                "Your answer MUST consist solely of a country of citizenship (e.g., \"United Kingdom of Great Britain and Ireland\") with no extra text. "
                ...
                "answer the following question: \"What is the country of citizenship of Gavinies?\"\n"
                "Answer:France\n\n"
