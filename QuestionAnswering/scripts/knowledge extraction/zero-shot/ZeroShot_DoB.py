...
def init_logging():
    ...
    fh = logging.FileHandler("/home/arianna/PycharmProjects/NIL_Grounding/data/QA_DoB/ZS_answers/logs/general_log.log", mode="w")
...
OUTPUT_DIR = f"/home/arianna/PycharmProjects/NIL_Grounding/data/QA_DoB/ZS_answers/ZS_{today_str}"
