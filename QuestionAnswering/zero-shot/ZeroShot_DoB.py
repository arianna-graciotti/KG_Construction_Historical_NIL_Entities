...
CONFIG = {
    "INPUT_CSVS": [
        "https://github.com/arianna-graciotti/KG_Construction_Historical_NIL_Entities/blob/291a694d0b0a58119113abf2af9430ac1c5f310b/QuestionAnswering/questions/QA_DoB_QID.csv",
        "https://github.com/arianna-graciotti/KG_Construction_Historical_NIL_Entities/blob/291a694d0b0a58119113abf2af9430ac1c5f310b/QuestionAnswering/questions/QA_DoB_NIL.csv"
    ],
...
def process_without_retrieval(df: pd.DataFrame, csv_basename: str, model: str):
    ...
    for _, r in tqdm(df.iterrows(), total=len(df)):
        ...
        prompt = (
            "Your task is to determine the date of birth of a given person occurring in a given sentence. "
